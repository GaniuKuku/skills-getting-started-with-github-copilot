...
activities = {
    ...
    "Basketball Club": {
        "description": "Pick-up games, drills, and interschool tournaments",
    ...
    "Robotics Club": {
        ...
        "schedule": "Mondays and Fridays, 3:45 PM - 5:30 PM",
        "max_participants": 12,
...
def unregister_from_activity(activity_name: str, email: str = Query(...)):
    """Unregister a student from an activity using their email address.
